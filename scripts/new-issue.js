 ...
 *   (sitemap.xml and llms.txt are generated by server.js from the JSON,
 *   so no manual sitemap edit is needed)
 *
...
async function main() {
  ...
  const headline = await ask('Short headline for the page title, max ~45 chars (e.g. "Pipeline Restarts Under Fire"): ');
